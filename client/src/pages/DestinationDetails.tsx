        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-[2fr_3fr] gap-8 mb-16">
            ...
            <div className="space-y-6">
              ...
              <div>
                <div
                  className={`grid grid-cols-2 md:grid-cols-3 gap-3 ${packageOptions.length > 9 ? 'max-h-[500px] overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-[#2c7338]/20 scrollbar-track-transparent hover:scrollbar-thumb-[#2c7338]/40' : ''}`}
                >
