      ...
      <section className="py-20 md:py-28 lg:py-36 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
            {t('about.heroTitle', 'About')} <span style={{ color: 'var(--primary)' }}>{t('about.heroGreeting', 'Us')} {t('platform_name', 'Simfinity')}</span>
          </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                ...
                <div className="group bg-white rounded-[2.5rem] border border-slate-200 overflow-hidden hover:shadow-xl hover:border-green-200 transition-all duration-300 flex flex-col h-full">
                  ...
                  <div className="p-8 text-center flex flex-col items-center flex-grow">
                    <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-[var(--primary)] transition-colors">{t('about.setup.step1.title', 'Scan QR Code')}</h3>
                ...
                <div className="group bg-white rounded-[2.5rem] border border-slate-200 overflow-hidden hover:shadow-xl hover:border-green-200 transition-all duration-300 flex flex-col h-full">
                  ...
                  <div className="p-8 text-center flex flex-col items-center flex-grow">
                    <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-[var(--primary)] transition-colors">{t('about.setup.step2.title', 'Activate eSIM')}</h3>
                    <p className="text-gray-500 leading-relaxed max-w-xs mx-auto text-lg">
                ...
                <div className="group bg-white rounded-[2.5rem] border border-slate-200 overflow-hidden hover:shadow-xl hover:border-green-200 transition-all duration-300 flex flex-col h-full">
                  ...
                  <div className="p-8 text-center flex flex-col items-center flex-grow">
                    <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-[var(--primary)] transition-colors">{t('about.setup.step3.title', 'Connect')}</h3>
                    <p className="text-gray-500 leading-relaxed max-w-xs mx-auto text-lg">
