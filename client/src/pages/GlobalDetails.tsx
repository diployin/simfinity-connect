...
export default function GlobalDetails() {
  ...
  const { data: packagesResponse = { data: { packages: [], pagination: undefined, region: undefined } }, isLoading } =
    useQuery<{ data: { packages: GlobalPackage[]; pagination?: any; region?: any } }>({
      queryKey: [
  ...
  const handleGetPlanClick = (e: any, selectedPkg: GlobalPackage) => {
    ...
    const hasVoice = (selectedPkg.voiceMinutes ?? 0) > 0;
      ...
      <div className="min-h-screen bg-background dark:bg-gray-950 flex flex-col">
        <div className="flex-1 flex items-center justify-center pt-20">
          <div className="text-center">
            ...
            <p className="mt-4 text-muted-foreground dark:text-gray-400">Loading global packages...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Breadcrumb className="mb-6">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator className="dark:text-gray-600" />
              <BreadcrumbItem>
                <BreadcrumbPage data-testid="breadcrumb-current" className="dark:text-white">Global eSIMs</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
                      ...
                      <div className="mt-4 pt-4 border-t border-border dark:border-gray-800">
                        ...
                        <div className="grid grid-cols-2 gap-2 max-h-48 overflow-y-auto custom-scrollbar">
                          {GLOBAL_COUNTRIES.map((country) => (
                            <div
                              key={country.code}
                              className="flex items-center gap-2 p-2 rounded-md bg-muted/50 dark:bg-gray-800/50"
                            >
                              <div className="w-6 h-4 rounded overflow-hidden border border-border dark:border-gray-700 shadow-sm flex-shrink-0">
                                <ReactCountryFlag
                                  svg
                              ...
                              <span className="text-sm text-foreground dark:text-gray-200 truncate">
                                {country.name}
                              </span>
                            </div>
                          ))}
            ...
            <div className="space-y-6">
              <div>
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h1 className="text-2xl md:text-3xl font-bold text-foreground dark:text-white tracking-tight">Global eSIM</h1>
                </div>
              ...
              <div className="w-full pb-28">
                {packageOptions.length === 0 ? (
                  <Card className="dark:bg-gray-900 border-border dark:border-gray-800">
                    <CardContent className="p-8 text-center">
                      <Globe className="h-12 w-12 text-muted-foreground dark:text-gray-500 mx-auto mb-4" />
