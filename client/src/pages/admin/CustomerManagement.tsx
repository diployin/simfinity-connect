  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card
          className="border-0 bg-gradient-to-br from-primary/5 to-indigo-50 dark:from-[#0a2e14]/30 dark:to-indigo-950/30 shadow-lg p-6"
                  ...
                  <div className="grid grid-cols-3 gap-3 pt-4">
                    <Card className="p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <Package className="h-4 w-4 text-primary-second dark:text-[var(--primary-light)]" />
                                  ...
                                  className={
                                    order.status === 'completed'
                                      ...
                                      : order.status === 'processing'
                                        ? 'bg-primary/10 text-[var(--primary-dark)] dark:bg-[var(--primary-dark)]/30 dark:text-[var(--primary-light)]'
                                        : order.status === 'failed'
                  ...
                  <ScrollArea className="h-[400px] pr-4">
                    <div className="space-y-3">
                      <div className="flex gap-3" data-testid="activity-account-created">
                        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary/10 dark:bg-[var(--primary-dark)]/30">
                          <UserCircle className="h-4 w-4 text-primary-second dark:text-[var(--primary-light)]" />
                        </div>
                        <div className="flex-1">
