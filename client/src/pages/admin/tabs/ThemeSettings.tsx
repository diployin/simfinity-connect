...
export function ThemeSettings() {
  ...
  return (
    <div className="space-y-6 dark:bg-gray-950 p-6">
      {/* Live Preview */}
      <Card className="border shadow-xl bg-gradient-to-br from-[var(--primary-light-hex)]/10 to-transparent border-[var(--primary-hex)]/20 dark:bg-gray-900 dark:border-gray-800">
        <CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          {/* Typography Preview */}
          <div className="p-6 bg-gradient-to-br from-[var(--primary-light-hex)]/10 to-transparent border border-[var(--primary-hex)]/20 rounded-xl dark:bg-gray-800 dark:border-gray-700">
            <h1 style={{ fontFamily: fonts.heading }} className="text-3xl font-bold mb-2 text-foreground">
              Heading Preview
            </h1>
        ...
        <CardContent className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {colorKeys.map(({ key, label, description, icon }) => (
              <Card
                key={key}
                className="bg-gradient-to-br from-[var(--primary-light-hex)]/10 to-transparent border border-[var(--primary-hex)]/20 hover:border-[var(--primary-hex)]/40 transition-all duration-300 hover:shadow-lg dark:from-gray-800/50 dark:to-gray-900/50 dark:border-gray-700 dark:hover:border-gray-600"
              >
                <CardContent className="pt-6 space-y-4">
                  <div className="flex items-start justify-between">
                    ...
                    >
                      <PopoverTrigger asChild>
                        <button
                          className="h-12 w-12 rounded-xl border-2 border-[var(--primary-hex)]/30 shadow-lg hover:scale-110 transition-all duration-300 cursor-pointer relative group dark:border-gray-600"
                      ...
                      <PopoverContent className="w-auto p-0 border-0 shadow-2xl dark:bg-gray-800">
                        <ChromePicker
                          color={colors[key]}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor={`input-${key}`} className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                      Hex Code
                    </Label>
                    <div className="flex gap-2">
                      <Input
                        ...
                        className="font-mono uppercase ring-2 ring-[var(--primary-hex)]/20 focus:ring-[var(--primary-hex)] h-10 bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100"
                        maxLength={7}
                      />
                      <Button
                        variant="outline"
                        size="icon"
                        className="h-10 w-10 flex-shrink-0 border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700"
                        onClick={() =>
                          setShowPickers((prev) => ({
                            ...prev,
                            [key]: !prev[key],
                  ...
                  <div className="space-y-2">
                    ...
                    <div
                      className="h-3 rounded-full shadow-inner dark:shadow-gray-800"
                      style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <Select value={fonts.heading} onValueChange={(value) => updateFont('heading', value)}>
                <SelectTrigger className="h-12 ring-2 ring-[var(--primary-hex)]/20 focus:ring-[var(--primary-hex)] dark:bg-gray-800 dark:border-gray-700">
                  <SelectValue />
                </SelectTrigger>
                  ...
                  {availableFonts.map((font) => (
                    <SelectItem key={font.value} value={font.value}>
                      <div className="flex items-center gap-2">
                        ...
                        <Badge
                          variant="outline"
                          className="text-xs bg-[var(--primary-light-hex)]/20 dark:border-gray-600"
                        >
                          {font.category}
                        </Badge>
                      </div>
              ...
              <div className="p-6 bg-gradient-to-br from-[var(--primary-light-hex)]/10 to-transparent border border-[var(--primary-hex)]/20 rounded-xl dark:bg-gray-800 dark:border-gray-700">
                ...
                <h2 style={{ fontFamily: fonts.heading }} className="text-2xl font-semibold mb-2 text-foreground">
                  Subheading Example
                </h2>
                <h3 style={{ fontFamily: fonts.heading }} className="text-xl font-medium text-foreground">
                  Smaller Heading
                </h3>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-6 bg-gradient-to-br from-[var(--primary-light-hex)]/10 to-transparent border border-[var(--primary-hex)]/20 rounded-xl dark:bg-gray-800 dark:border-gray-700">
                <p style={{ fontFamily: fonts.body }} className="text-base mb-3 leading-relaxed text-foreground">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Button
          ...
          disabled={isLoading}
          variant="outline"
          className="gap-2 h-12 px-6 border-[var(--primary-hex)] text-[var(--primary-hex)] hover:bg-[var(--primary-hex)] hover:text-black transition-all duration-300 dark:border-gray-700"
        >
          {isLoading ? (
            <>
              <Loader2 className="h-5 w-5 animate-spin" />
        ...
        <Button
          onClick={handleReset}
          variant="outline"
          className="gap-2 h-12 px-6 hover:bg-destructive hover:text-destructive-foreground transition-all duration-300 dark:border-gray-700"
        >
      ...
      {/* Info Card */}
      <Card className="border-0 shadow-xl border-l-4 border-l-blue-500 dark:bg-gray-900">
