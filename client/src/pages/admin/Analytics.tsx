      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card className="border-0 bg-gradient-to-br from-primary/5 to-indigo-50 dark:from-[#0a2e14]/30 dark:to-indigo-950/30 shadow-lg p-6" data-testid="card-analytics-revenue">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-xs text-primary-second dark:text-[var(--primary-light)] mt-2 font-medium" data-testid="text-analytics-revenue-trend">
                {stats?.trends.revenue >= 0 ? "+" : ""}{stats?.trends.revenue.toFixed(1)}% {t('admin.analytics.vsLastMonth', 'vs last month')}
              </p>
            </div>
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-primary-second to-indigo-600">
        ...
        <Card className="border-0 bg-gradient-to-br from-emerald-50 to-primary/5 dark:from-emerald-950/30 dark:to-[#0a2e14]/30 shadow-lg p-6">
          <div className="flex items-start justify-between">
            ...
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-600 to-primary-second">
        ...
        <Card className="border-0 bg-gradient-to-br from-primary/5 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 shadow-lg p-6">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-xs text-primary-second dark:text-[var(--primary-light)] mt-2 font-medium">
                +{stats?.trends.customers || 0} {t('admin.analytics.newThisMonth', 'new this month')}
              </p>
            </div>
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-primary-second to-pink-600">
              ...
              <Card key={provider.id} className="border-0 shadow-lg" data-testid={`card-provider-${provider.slug}`}>
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="px-3 py-1 rounded-full bg-primary/10 dark:bg-[var(--primary-dark)]/30 text-primary-second dark:text-[var(--primary-light)] text-xs font-medium">
