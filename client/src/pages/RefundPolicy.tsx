          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">{t('refund.sec1Desc', 'We offer refunds under the following conditions:')}</p>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground">{t('refund.sec6Desc', 'If you have questions about our refund policy, please contact us at:')}<br />
