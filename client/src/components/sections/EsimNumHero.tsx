        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 lg:gap-4">
          ...
          <div className="flex-1 text-center lg:text-left pt-2 sm:pt-4 lg:pt-12 lg:max-w-xl">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-3 sm:mb-4">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-second to-[var(--primary)]">
                eSIM
              </span>{" "}
            ...
            <div className="hidden sm:flex flex-wrap items-center gap-3 justify-center lg:justify-start mb-4">
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/5 dark:bg-violet-950/40 border border-primary/10 dark:border-[var(--primary-dark)]/50">
                <div className="flex items-center justify-center h-5 w-5 rounded-full bg-[var(--primary)] text-white text-[10px] font-bold">1</div>
                <MapPin className="h-3.5 w-3.5 text-primary-second dark:text-[var(--primary-light)]" />
                <span className="text-xs font-medium text-primary-second dark:text-[var(--primary-light)]">{t("website.home.hero.step1", "Choose Destination")}</span>
              </div>
          ...
          <div className="flex justify-center lg:justify-end relative flex-shrink-0 w-full lg:w-auto">
            ...
            <div className="hidden sm:block absolute -top-16 -left-16 w-40 h-40 bg-primary/10 dark:bg-[var(--primary-dark)]/40 rounded-full blur-3xl opacity-50 z-0" />
            <div className="hidden sm:block absolute top-40 -right-8 w-48 h-48 bg-primary/10 dark:bg-[var(--primary-dark)]/40 rounded-full blur-3xl opacity-50 z-0" />
                  ...
                  <div className="px-3 sm:px-4 lg:px-5 pt-8 sm:pt-10 lg:pt-12 pb-4 sm:pb-5 lg:pb-6 space-y-3 sm:space-y-4 lg:space-y-5" style={{ minHeight: '420px' }}>
                    ...
                    <div className="flex items-center justify-center gap-3 sm:gap-4 lg:gap-6">
                      <button
                        ...
                        className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 lg:px-5 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm font-medium transition-colors ${activeTab === "country"
                            ? "bg-primary/10 text-primary-second"
                            : "text-gray-500 hover:text-gray-700"
                          }`}
                        data-testid="tab-phone-country"
                      >
                        <div className={`h-4 w-4 sm:h-5 sm:w-5 rounded-full border-2 flex items-center justify-center ${activeTab === "country" ? "border-[var(--primary)]" : "border-gray-400"
                          }`}>
                          {activeTab === "country" && (
                            <div className="h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-[var(--primary)]" />
                          )}
                        </div>
                      ...
                      >
                        <div className={`h-4 w-4 sm:h-5 sm:w-5 rounded-full border-2 flex items-center justify-center ${activeTab === "region" ? "border-[var(--primary)]" : "border-gray-400"
                          }`}>
                          {activeTab === "region" && (
                            <div className="h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-[var(--primary)]" />
                          )}
                    ...
                    <div className="relative flex items-center">
                      <input
                        ...
                        className="w-full pl-3 sm:pl-4 lg:pl-5 pr-10 sm:pr-12 lg:pr-14 h-10 sm:h-12 lg:h-14 rounded-full border-2 border-primary/10 focus:border-[var(--primary-light)] focus:outline-none text-xs sm:text-sm text-gray-700 bg-white placeholder:text-gray-400"
                        data-testid="input-phone-search"
                      />
                      <button
                        className="absolute right-1 sm:right-1.5 h-8 w-8 sm:h-9 sm:w-9 lg:h-11 lg:w-11 rounded-full bg-[var(--primary)] hover:bg-primary-second flex items-center justify-center transition-colors"
                          ...
                          {filteredCountries.length > 0 ? (
                            filteredCountries.map((country) => (
                              ...
                              >
                                ...
                                <span className="text-[9px] sm:text-[10px] lg:text-xs font-medium text-gray-700 text-center leading-tight line-clamp-2 group-hover:text-primary-second">
                            ...
                            filteredRegions.map((region) => (
                              ...
                              >
                                <div className="h-7 w-7 sm:h-8 sm:w-8 lg:h-10 lg:w-10 rounded-md sm:rounded-lg bg-gradient-to-br from-primary/10 to-primary/10 flex items-center justify-center flex-shrink-0">
                                  <Globe className="h-3.5 w-3.5 sm:h-4 sm:w-4 lg:h-5 lg:w-5 text-primary-second" />
                                </div>
                    ...
                    <div className="pt-2 sm:pt-3 lg:pt-4">
                      <Link href="/destinations">
                        <button
                          className="w-full h-10 sm:h-12 lg:h-14 rounded-full bg-gradient-to-r from-primary-second to-[var(--primary)] hover:from-[var(--primary-dark)] hover:to-primary-second text-white font-semibold text-xs sm:text-sm lg:text-base transition-all"
