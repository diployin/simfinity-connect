...
export function DownloadApp() {
  ...
  return (
    <section id="download" className="py-10 md:py-16 bg-background dark:bg-gray-950">
            ...
            <div className="flex flex-wrap gap-3 mb-6">
              <a href={iosLink} className="inline-block" aria-label="Download on App Store">
                <div className="bg-black text-white rounded-lg px-4 py-2.5 flex items-center gap-2 hover:bg-gray-800 transition-colors">
                  ...
                  <div>
                    <div className="text-[10px] leading-none">{t('website.home.downloadApp.iosLabel', 'Download on the')}</div>
                    <div className="text-sm font-semibold leading-tight">{t('website.home.downloadApp.iosName', 'App Store')}</div>
                  </div>
                </div>
              </a>
              <a href={androidLink} className="inline-block" aria-label="Get it on Google Play">
                <div className="bg-black text-white rounded-lg px-4 py-2.5 flex items-center gap-2 hover:bg-gray-800 transition-colors">
                  ...
                  <div>
                    <div className="text-[10px] leading-none">{t('website.home.downloadApp.androidLabel', 'GET IT ON')}</div>
                    <div className="text-sm font-semibold leading-tight">{t('website.home.downloadApp.androidName', 'Google Play')}</div>
                  </div>
                </div>
              </a>
            </div>
