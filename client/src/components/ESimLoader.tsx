export default function ESimLoader() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-[#f0f9f1] to-white dark:from-gray-950 dark:to-gray-900">
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col items-center gap-2">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-lg font-bold bg-gradient-to-r from-[#2c7338] to-[#3d9a4d] bg-clip-text text-transparent">
              finity
            </span>
          </div>
