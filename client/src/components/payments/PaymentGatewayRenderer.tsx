...
export default function PaymentGatewayRenderer({
  ...
  if (initData.provider === 'powertranz') {
    ...
    if (powertranzState === 'method_select') {
      return (
        <Card className="border-2 border-primary/20 dark:border-primary-dark/30">
          <CardContent className="p-8">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg hover:border-primary hover:bg-primary/5 dark:hover:bg-primary-dark/10 transition-all text-left"
              >
              ...
              <button
                ...
                className="w-full p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg hover:border-primary-second hover:bg-primary-second/5 dark:hover:bg-primary-second/10 transition-all text-left"
              >
                <div className="flex items-start gap-3">
            ...
            <div className="mt-6 p-3 bg-primary/5 dark:bg-primary-dark/10 border border-primary/20 dark:border-primary-dark/30 rounded-lg flex items-start gap-2">
              <AlertCircle className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
              <p className="text-xs text-primary/80 dark:text-primary-light">
    ...
    if (powertranzState === 'hpp_redirect') {
      return (
        <Card className="border-primary/20 dark:border-primary-dark/30 bg-primary/5 dark:bg-primary-dark/10">
