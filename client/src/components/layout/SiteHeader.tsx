            ...
            <Link href="/" data-testid="link-home" className="flex-shrink-0">
              <div className="flex items-center gap-2 cursor-pointer transition-all duration-200 hover:opacity-80">
                ...
                <span className="font-bold text-lg text-gray-900 dark:text-white">
                  Sim<span className="bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent">finity</span>
                </span>
              </div>
            </Link>
          )}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <Link href="/destinations?tab=countries" onClick={() => setActiveMenu(null)}>
                      <div className="flex items-start gap-3 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors group cursor-pointer">
                        <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-primary/5 dark:bg-[var(--primary-dark)]/30 flex items-center justify-center group-hover:bg-primary/10 dark:group-hover:bg-[var(--primary-dark)]/50 transition-colors">
                  ...
                  return (
                    <DropdownMenuItem
                      ...
                      className={cn(
                        ...
                        active ? 'bg-primary/5 dark:bg-[var(--primary-dark)]/20' : 'hover:bg-gray-50 dark:hover:bg-gray-800',
                      )}
                    >
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <div>
                          <div className={cn('font-medium text-sm', active ? 'text-primary-second dark:text-[var(--primary-light)]' : 'text-gray-700 dark:text-gray-300')}>
                            {lang.nativeName}
                          </div>
                          <div className="text-xs text-gray-500">{lang.name}</div>
                        </div>
                      </div>
                      {active && <div className="h-2 w-2 rounded-full bg-[var(--primary)]" />}
                    </DropdownMenuItem>
                  );
                })}
              </DropdownMenuContent>
                ...
                <nav className="flex flex-col p-5 space-y-1">
                  ...
                  <div className="pt-4 mt-4 border-t border-gray-100 dark:border-gray-800 space-y-3">
                    ...
                    <div>
                      ...
                      {languageOpen && (
                        <div className="ml-3 mt-2 space-y-1 border-l-2 border-[var(--primary)]/30 pl-3 max-h-60 overflow-y-auto">
                          {languages.map((lang) => (
                            <button
                              key={lang.code}
