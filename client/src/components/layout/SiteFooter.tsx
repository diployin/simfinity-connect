...
import { FaInstagram, FaFacebookF, FaYoutube, FaLinkedinIn, FaAndroid, FaAppStore } from 'react-icons/fa';
...
export function NewFooter() {
  ...
  const socialLinks = [
    { icon: FaInstagram, href: getSocialUrl(settings?.social_instagram), label: "Instagram", hover: "group-hover:text-pink-500" },
    { icon: FaFacebookF, href: getSocialUrl(settings?.social_facebook), label: "Facebook", hover: "group-hover:text-blue-600" },
  ...
  return (
    <footer className=" bg-gray-900 py-12 md:py-16 border-t border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a href={settings?.social_ios || "#"} className="inline-block" aria-label="Download on App Store">
                <img
              ...
              <a href={settings?.social_android || "#"} className="inline-block" aria-label="Get it on Google Play">
                <img
      ...
      "
              >
                <social.icon
                  className={`h-5 w-5 transition-colors ${social.hover}`}
                />
              </a>
            ))}
          </div>
