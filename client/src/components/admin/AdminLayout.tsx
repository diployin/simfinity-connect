      ...
      >
        ...
        <div className="flex h-16 items-center justify-between px-6 border-b border-slate-200 dark:border-slate-800 shrink-0">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary-dark shadow-lg shadow-[var(--primary)]/50">
                ...
                <div key={entry.groupName} className="space-y-1">
                  <button
                    ...
                    className={cn(
                      ...
                      isGroupActive
                        ? 'text-primary-second dark:text-[var(--primary-light)]'
                          ...
                          <Link key={item.name} href={item.href}>
                            <div
                              className={cn(
                                ...
                                isActive
                                  ? 'bg-gradient-to-r from-primary to-primary-dark text-white shadow-lg shadow-[var(--primary)]/30'
