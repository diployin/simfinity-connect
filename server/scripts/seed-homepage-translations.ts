...
const homepageKeys: Record<string, string> = {
  ...
  'home.faq.q4.question': 'Where does Voltey work?',
  'home.faq.q4.answer':
  ...
  'home.testimonials.title': 'What travelers say about Voltey',
  'home.testimonials.viewAll': 'View all destinations',
  'home.testimonials.t1':
    'I used Voltey during my trip to Japan and it worked perfectly from the moment I landed. Setup took less than two minutes and the data speed was amazing!',
  ...
  'home.testimonials.t4':
    'I was surprised how smooth everything was. Voltey saved me from buying local SIMs and hunting for Wi-Fi. Great coverage and fair pricing.',
  'home.testimonials.t5':
    "I've tried other eSIMs before, but Voltey was by far the easiest to activate. Customer support helped me within minutes when I had a question.",
  ...
  // HowItWorksSteps
  'home.howItWorks.title': 'How does Voltey work',
...
const languageTranslations: Record<string, Record<string, string>> = {
  ar: {
    ...
    'home.faq.q4.question': 'أين تعمل Voltey؟',
    ...
    'home.testimonials.title': 'ماذا يقول المسافرون عن Voltey',
    'home.testimonials.viewAll': 'عرض جميع الوجهات',
    'home.howItWorks.title': 'كيف تعمل Voltey',
  ...
  de: {
    ...
    'home.howItWorks.title': 'So funktioniert Voltey',
    ...
    'home.testimonials.title': 'Was Reisende über Voltey sagen',
  ...
  es: {
    ...
    'home.howItWorks.title': 'Cómo funciona Voltey',
    ...
    'home.testimonials.title': 'Lo que dicen los viajeros sobre Voltey',
  ...
  fr: {
    ...
    'home.howItWorks.title': 'Comment fonctionne Voltey',
    ...
    'home.testimonials.title': 'Ce que disent les voyageurs sur Voltey',
  ...
  hi: {
    ...
    'home.howItWorks.title': 'Voltey कैसे काम करता है',
    ...
    'home.testimonials.title': 'Voltey के बारे में यात्री क्या कहते हैं',
  ...
  it: {
    ...
    'home.howItWorks.title': 'Come funziona Voltey',
    ...
    'home.testimonials.title': 'Cosa dicono i viaggiatori di Voltey',
  ...
  ja: {
    ...
    'home.howItWorks.title': 'Volteyの仕組み',
    ...
    'home.testimonials.title': '旅行者がVolteyについて言うこと',
  ...
  pl: {
    ...
    'home.howItWorks.title': 'Jak działa Voltey',
    ...
    'home.testimonials.title': 'Co mówią podróżnicy o Voltey',
  ...
  pt: {
    ...
    'home.howItWorks.title': 'Como funciona o Voltey',
    ...
    'home.popular.unlimited': 'ILIMITADO',
    'home.testimonials.title': 'O que os viajantes dizem sobre o Voltey',
  ...
  sv: {
    ...
    'home.howItWorks.title': 'Så fungerar Voltey',
    ...
    'home.testimonials.title': 'Vad resenärer säger om Voltey',
  ...
  zh: {
    ...
    'home.howItWorks.title': 'Voltey如何工作',
    ...
    'home.testimonials.title': '旅行者对Voltey的评价',
